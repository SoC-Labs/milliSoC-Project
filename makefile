...
else ifeq ($(CPU_TYPE), CM85)
	FLIST_INCLUDES += $(SOCLABS_MILLISOC_TECH_DIR)/flist/IP/CortexM85_BEHAV.flist
	FLIST_INCLUDES += $(SOCLABS_MILLISOC_TECH_DIR)/flist/IP/CortexM85.flist
endif
